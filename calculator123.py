...
root.geometry("361x381+10+10")
val=""
data=StringVar()
display=Entry(root,textvariable=data,bd=29,bg="white",justify="center",font=("Arial",20))
...
btnc=Button(root,text="c",font=("Arial",12,"bold"),bd=12,height=2,width=6,command=lambda:btnclear())
...
btn_eqal=Button(root,text="=",font=("Arial",12,"bold"),bd=12,height=2,width=6,command=lambda:btnEqual()).grid(row = 4, column = 3,)
root.mainloop()
